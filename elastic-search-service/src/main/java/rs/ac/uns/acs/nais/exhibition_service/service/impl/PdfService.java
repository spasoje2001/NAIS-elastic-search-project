...
public class PdfService implements IPdfService {
    ...
    private void addContentToExhibitionDocument(Document document, Integer organizerId, List<Exhibition> exhibitions) throws DocumentException {
        ...
        Paragraph heading = new Paragraph("Exhibition Attendance Report", font); // IZMENITI NASLOV
        ...
        for (Exhibition exhibition : exhibitions) {
            ...
            // String startDateFormatted = exhibition.getStartDate().atStartOfDay().toInstant().atZone(ZoneId.systemDefault()).toLocalDate().format(dateFormatter);
